        ...
        <div className="min-h-screen flex flex-col gap-4 md:gap-8 transition-colors duration-300 mt-4 px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                <div className="bg-white dark:bg-gray-800 p-4 md:p-5 rounded-lg shadow text-left">
                    <h2 className="text-xs md:text-sm uppercase text-black dark:text-gray-400 mb-1">Total Tasks</h2>
                    <p className="text-xl md:text-2xl font-bold text-[#00CCFF]">{tasks.length}</p>
                </div>
                <div className="bg-white dark:bg-gray-800 p-4 md:p-5 rounded-lg shadow text-left">
                    <h2 className="text-xs md:text-sm uppercase text-black dark:text-gray-400 mb-1">Total Hours</h2>
                    <p className="text-xl md:text-2xl font-bold text-[#00CCFF]">{totalHours}</p>
                </div>
                <div className="bg-white dark:bg-gray-800 p-4 md:p-5 rounded-lg shadow text-left">
                    <h2 className="text-xs md:text-sm uppercase text-black dark:text-gray-400 mb-1">Total Resources</h2>
                    <p className="text-xl md:text-2xl font-bold text-[#00CCFF]">{totalResources}</p>
                </div>
            </div>
                        ...
                        <div className="overflow-hidden border border-gray-300 dark:border-gray-700 rounded-lg">
                            <table className="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                                <thead className="bg-[#003399]">
                                    <tr>
                                        <th className="py-3 px-3 sm:px-4 text-left text-xs sm:text-sm font-semibold text-white">TITLE</th>
                                        <th className="py-3 px-3 sm:px-4 text-left text-xs sm:text-sm font-semibold text-white">DEPARTMENT</th>
                                        <th className="py-3 px-3 sm:px-4 text-left text-xs sm:text-sm font-semibold text-white">HOURS</th>
